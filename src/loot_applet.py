...
class LootResultRow(QFrame):
    def __init__(
        ...
        title_base_size = title_font.pointSize()
        title_font.setPointSize((title_base_size + 4) if title_base_size > 0 else 15)
...
class LootAppletWidget(QWidget):
    ...
    def _save_preset(self) -> None:
        ...
        try:
            ...
            ) or generate_named_object_id(cleaned_name, "loot_preset")
            write_dmt_package(
                path,
                info={
